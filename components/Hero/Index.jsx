          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="flex flex-col gap-7 flex-1 lg:pl-12 text-qiskit-white">
              <h1 className="font-bold text-center lg:text-left text-4xl lg:text-6xl 2xl:text-7xl leading-[4.5rem]">
                <Typewriter
                  options={{
                    strings: ["International AI Summit #2"],
                    autoStart: true,
                    loop: true,
                  }}
                />
              ...
              <div className="flex items-end">
                ...
                <a href="https://unstop.com/workshop/international-ai-summit-2-g-h-raisoni-institute-of-engineering-and-technology-ghriet-nagpur-maharashtra-578300?lb=XDyfE8N"><button type="button button2"><i>Register Now!</i></button></a>
                </div>
              </div>
            </div>
